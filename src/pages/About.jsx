    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          ...
          <p>
            The app integrates features such as real-time availability,
            reminders, and customizable booking options. Prescripto aims to
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border rounded-lg px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-customOrange hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
          <b>Efficiency:</b>
